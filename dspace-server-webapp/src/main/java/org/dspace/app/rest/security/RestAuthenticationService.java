...
public interface RestAuthenticationService {
     ...
     * @param addCookie      boolean, whether to save the generated auth token to a Cookie or not. Default is false.
     *                       However, some authentication methods may require this information be saved to a cookie
     *                       (even temporarily) in order to complete the login process (e.g. Shibboleth requires this)
     */
