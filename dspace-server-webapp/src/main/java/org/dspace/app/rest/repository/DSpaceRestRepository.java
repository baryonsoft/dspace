...
public abstract class DSpaceRestRepository<T extends RestAddressableModel, ID extends Serializable>
     ...
     * @param entity  the REST object to update
     *
     * @return the new state of the REST object after persistence
     *
     * @throws RepositoryMethodNotImplementedException returned by the default implementation when the
     *                                                 operation is not supported for the entity
     */
     ...
     * the actual object to state that it exists. This could lead to retrieve and initialize a lot of linked objects
     */
     ...
     * method doesn't allow pagination, and it could be misused to retrieve a thousand objects at once
     */
     ...
     *
     * @param context the dspace context
     * @param id      the id of the rest object to delete
     *
     * @throws RepositoryMethodNotImplementedException returned by the default implementation when
     *                                                 the operation is not supported for the entity
     */
    ...
    @Override
    /**
     * Method to implement to allow deleting of a specific entity instance
     */
     ...
     *
     * @param context the dspace context
     * @param uuid    The uuid of the parent object retrieved from the query param.
     *
     * @return the created REST object
     *
     * @throws RepositoryMethodNotImplementedException returned by the default implementation when the
     ...
     *
     * @param context the dspace context
     * @param list    The list of Strings that will be used as data for the object that's to be created
     *                This list is retrieved from the uri-list body
     *
     * @return the created REST object
     *
     * @throws RepositoryMethodNotImplementedException returned by the default implementation
     *                                                 when the operation is not supported for the entity
     */
     ...
     *
     * @param request    the http request
     * @param uploadfile the file to process
     *
     ...
     * @throws RepositoryMethodNotImplementedException returned by the default implementation when the operation
     *                                                 is not supported for the entity
     */
