...
public interface ItemDAO extends DSpaceObjectLegacySupportDAO<Item> {
    ...
    ScrollableResults findAllReadOnly(Context context, boolean archived) throws SQLException;
    ...
    ScrollableResults findAllReadOnly(Context context, boolean archived, boolean withdrawn) throws SQLException;
     ...
     */
    ScrollableResults findByLastModifiedSinceReadOnly(Context context, Date since)
        throws SQLException;
    ...
    Iterator<Item> findByMetadataQuery(Context context, List<List<MetadataField>> listFieldList,
    ...
    ScrollableResults findAllReadOnly(Context context, boolean archived,
                                      boolean withdrawn, boolean discoverable, Date lastModified)
        throws SQLException;
